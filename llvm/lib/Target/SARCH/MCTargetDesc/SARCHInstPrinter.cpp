...
#include "SARCHGenAsmWriter.inc"

void SARCHInstPrinter::printRegName(raw_ostream &O, MCRegister Reg) {
  O << getRegisterName(Reg);
}

void SARCHInstPrinter::printInst(const MCInst *MI, uint64_t Address,
...
void SARCHInstPrinter::printOperand(const MCInst *MI, int OpNo,
                                    raw_ostream &O) {
